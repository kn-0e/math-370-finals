...
\titlegraphic{\includegraphics[width=1.1\textwidth]{UMass Seal Small-Reversed.png}}
...
\block{}{
    ...
    \vspace{0.5em}
    \begin{tikzfigure}[]
        \includegraphics[width=0.6\linewidth]{ham_sandwich.png}
    \end{tikzfigure}
}

\block{Conclusions \& Further Directions}{
    This poster proves the $S^2\to\mathbf{R}^2$ case of the Borsuk-Ulam
    theorem. Future work could explore the generalized theorem:
